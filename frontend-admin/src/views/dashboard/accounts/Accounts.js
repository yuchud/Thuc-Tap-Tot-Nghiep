...
import YearlyCreatedAcconts from './components/YearlyCreatedAcconts';
...
import MonthlyCreatedAccounts from './components/MonthlyCreatedAccounts';
      ...
      <Box>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} lg={4}>
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <YearlyCreatedAcconts selectedYear={selectedYear} />
              </Grid>
              <Grid item xs={12}>
                <MonthlyCreatedAccounts selectedYear={selectedYear} selectedMonth={selectedMonth} />
              </Grid>
            </Grid>
          </Grid>
        </Grid>
